...
# You are provided with a Python script that is supposed to guide 
# a user through an adventure game, but it has some errors. 
...
if place == "forest":
    ...
    if action == "light a torch":
        print("you discover ancient cave drawings!")
    else:
        print("You stub your toe. Ouch!")
        

# Task 3: Default Path

# If the user makes an invalid choice at any point, 
# use the pass statement for now. Later, you can enhance 
# this to provide feedback or a different branch of the story.
